...
from elements import Interface, Message, State, ChoicePoint, Transition, CodeType, ElementType
...
class PlantUMLManager:
    ...
    def set_elements(self, plantuml_code: str):
        ...
        self.messages.append(Message(0, "Timeout"))
        self.messages.append(Message(0, "No"))
        self.messages.append(Message(0, "Yes"))
    ...
    def add_transition(self, source_name: str, target_name: str, connector_type: str, connector_length: int):
    ...
    def get_plantuml_code(self, code_type: CodeType) -> str:
        if code_type == CodeType.MASKED:
            plantuml_code = HEADER_MASKED_PLANTUML_CODE + DEFAULT_MESSAGES_PLANTUML_CODE
        else:
